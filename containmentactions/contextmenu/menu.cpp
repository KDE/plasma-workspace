...
void ContextMenu::restore(const KConfigGroup &config)
{
    ...
    if (!m_runCommandAction) {
        ...
        m_openTerminalAction->setIcon(QIcon::fromTheme(u"utilities-terminal-symbolic"_s));
        ...
        m_logoutAction = new QAction(i18nc("plasma_containmentactions_contextmenu", "Show Logout Screen"), this);
