    ...
    Kirigami.FormLayout {
        ...
        RowLayout {
            ...
            Kirigami.ContextualHelpButton {
                toolTipText: xi18ndc("plasma_wallpaper_org.kde.image", "@info:tooltip", "Set all times to 0 to disable automatic wallpaper changing. You can still change wallpapers manually with the <interface>Next Wallpaper Image</interface> menu item in the desktop context menu.")
            }
        }
    }
