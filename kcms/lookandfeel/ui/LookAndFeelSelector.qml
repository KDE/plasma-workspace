...
KCM.GridViewKCM {
    ...
    title: {
        if (variant === "light") {
            return i18nc("@title:window", "Choose default light global theme");
        } else {
            return i18nc("@title:window", "Choose default dark global theme");
        }
    }
    ...
    view.delegate: KCM.GridDelegate {
        ...
        onClicked: {
            ...
            if (selector.variant === "light") {
                kcm.settings.defaultLightLookAndFeel = model.pluginName;
            } else if (selector.variant === "dark") {
    ...
    Private.ItemModelRow {
        ...
        role: "pluginName"
        value: variant === "light" ? kcm.settings.defaultLightLookAndFeel : kcm.settings.defaultDarkLookAndFeel
    }
}
