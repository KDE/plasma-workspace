        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    Label {
                        Layout.alignment: Qt.AlignHCenter
                        text: schedulePreview.endSunriseDateTime.toLocaleString(Qt.locale(), "h:mm")
                        textFormat: Text.PlainText
                    }
                ...
                ColumnLayout {
                    ...
                    Label {
                        Layout.alignment: Qt.AlignHCenter
                        text: schedulePreview.startSunsetDateTime.toLocaleString(Qt.locale(), "h:mm")
                        textFormat: Text.PlainText
                    }
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                DecimalSpinBox {
                    ...
                    onValueModified: kcm.settings.latitude = value
                ...
                DecimalSpinBox {
                    ...
                    onValueModified: kcm.settings.longitude = value
