...
PlasmoidItem {
    ...
    readonly property string title: i18nd("plasma_applet_org.kde.plasma.manageinputmethod", "Show On-Screen Keyboard")
    ...
    Plasmoid.contextualActions: [
        ...
        PlasmaCore.Action {
            text: i18nc("@action:tray context menu", "Touch, Tablet, and Mouse")
    ...
    states: [
        State {
            ...
            PropertyChanges {
                ...
                root.toolTipSubText: i18nd("plasma_applet_org.kde.plasma.manageinputmethod", "On-Screen Keyboard: unavailable")
            }
        },
        State {
            name: "disabled"
            ...
            PropertyChanges {
                ...
                root.toolTipSubText: i18nd("plasma_applet_org.kde.plasma.manageinputmethod", "Configured not to show automatically")
            }
        },
        State {
            id: unsupportedState
            ...
            PropertyChanges {
                ...
                root.toolTipMainText: root.title
                root.toolTipSubText: i18nd("plasma_applet_org.kde.plasma.manageinputmethod", "Current application does not support input methods; click to show on-screen keyboard in hardware keyboard emulation mode")
            }
        },
        State {
            name: "visible"
            ...
            PropertyChanges {
                ...
                root.toolTipMainText: i18nd("plasma_applet_org.kde.plasma.manageinputmethod", "Hide On-Screen Keyboard")
            }
        },
        State {
            name: "touchOnly"
            ...
            PropertyChanges {
                ...
                root.Plasmoid.status: Kirigami.Settings.tabletMode ? PlasmaCore.Types.ActiveStatus : PlasmaCore.Types.PassiveStatus
                root.toolTipMainText: root.title
                root.toolTipSubText: i18nd("plasma_applet_org.kde.plasma.manageinputmethod", "Shows automatically when tapping an input field")
            }
        },
        State {
            name: "alwaysOn"
            ...
            PropertyChanges {
                ...
                root.Plasmoid.status: PlasmaCore.Types.ActiveStatus
                root.toolTipMainText: root.title
                root.toolTipSubText: i18nd("plasma_applet_org.kde.plasma.manageinputmethod", "Shows automatically when clicking an input field")
            }
        }
    ]
}
