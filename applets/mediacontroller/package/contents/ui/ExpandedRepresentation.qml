        ...
        ShaderEffect {
            ...
            states: State {
                ...
                PropertyChanges {
                    ...
                    sourceRect: Qt.rect(shaderEffectSource.sourceItem.width - shaderEffectSource.sourceItem.currentItem.paintedWidth, Math.round((shaderEffectSource.sourceItem.height - shaderEffectSource.sourceItem.currentItem.paintedHeight) / 2), shaderEffectSource.sourceItem.currentItem.paintedWidth, shaderEffectSource.sourceItem.currentItem.paintedHeight)
                }
            }
        }
        RowLayout {
            ...
            AlbumArtStackView {
                ...
                Connections {
                    ...
                    function onExpandedChanged() {
                        ...
                        if (!Plasmoid.expanded || (albumArt.albumArt.currentItem instanceof Image && albumArt.albumArt.currentItem.source == root.albumArt)) {
                            return;
                        }
                        albumArt.loadAlbumArt();
                    }
    ...
    footer: PlasmaExtras.PlasmoidHeading {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                TextMetrics {
                    id: timeMetrics
                    text: i18nc("Remaining time for song e.g -5:42", "-%1", KCoreAddons.Format.formatDuration(seekSlider.to / 1000, expandedRepresentation.durationFormattingOptions))
                ...
                PlasmaComponents3.Label {
                    ...
                    text: i18nc("Remaining time for song e.g -5:42", "-%1", KCoreAddons.Format.formatDuration((seekSlider.to - seekSlider.value) / 1000, expandedRepresentation.durationFormattingOptions))
                    opacity: 0.9
                    font: PlasmaCore.Theme.smallestFont
                    color: PlasmaCore.ColorScope.textColor
                }
    ...
    header: PlasmaExtras.PlasmoidHeading {
        ...
        PlasmaComponents3.TabBar {
            ...
            Repeater {
                ...
                onModelChanged: {
                    playerSelector.currentIndex = model.findIndex(data => {
                            return data.source === mpris2Source.current;
                        });
                }
            }
        }
