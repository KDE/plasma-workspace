...
RowLayout {
    ...
    PlasmaComponents3.TextField {
        ...
        placeholderText: replyRow.placeholderText || i18ndc("plasma_applet_org.kde.plasma.notifications", "Text field placeholder", "Type a reply…")
        onAccepted: {
    ...
    PlasmaComponents3.Button {
        ...
        text: replyRow.buttonText || i18ndc("plasma_applet_org.kde.plasma.notifications", "@action:button", "Send")
