...
MouseArea {
    ...
    */
    ...
    function setupLabels() {
        ...
        if (showTimezone) {
            ...
            case 0: // Code
                ...
                break;
            case 1: // City
                timezoneString = TimeZonesI18n.i18nCity(clock.timeZonneName);
                break;
            case 2: // Offset from UTC time
                timezoneString = clock.getTimezoneOffset;
                break;
            }
    ...
    Component.onCompleted: {
        Plasmoid.configuration.selectedTimeZones = TimeZoneUtils.sortTimeZones(Plasmoid.configuration.selectedTimeZones);
