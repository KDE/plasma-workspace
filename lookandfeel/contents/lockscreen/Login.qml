...
Item {
    ...
    function startLogin() {
        ...
        //work around a bug in TextHandle in QQC
        //for some reason, it changes the parent if activeFocus is set
        //this means if we close the window when the control is activeFocus
        //however on app shutdown this leads us to reparent whilst the parent item (the TextInputWithHandles object) is destroying it's children
        //this leads to a nasty crash
