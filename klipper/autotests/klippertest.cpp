...
/**
    Verify that slotPopupMenu() toggles the popup visibility: hides it
    when already visible instead of calling show() again.

    @see klipper/klipper.cpp Klipper::slotPopupMenu()
 */
