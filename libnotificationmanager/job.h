...
class NOTIFICATIONMANAGER_EXPORT Job : public QObject
{
     ...
     */
    Q_PROPERTY(AmountType amountType READ amountType NOTIFY textChanged)
...
public:
     ...
     */
    enum AmountType {
        AmountTypeNone, ///< The text carries none of them, so every amount is the view's to show.
        AmountTypeFiles, ///< The text counts files, as in "42 of 1337 files".
        AmountTypeItems, ///< The text counts items, as in "42 of 1337 items".
    };
    Q_ENUM(AmountType)
