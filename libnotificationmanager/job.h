...
class NOTIFICATIONMANAGER_EXPORT Job : public QObject
{
    ...
    /**
     * The speed readings taken so far, spread over 100 points of progress. Kept by the job, not by
     * whatever draws it, so a chart opened halfway through still has the whole job.
     */
