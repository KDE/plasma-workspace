    ...
    , m_mode(mode)
{
    ...
    winId();
    const KConfigGroup windowConfig = KSharedConfig::openStateConfig()->group(u"Window"_s);
...
{
    KConfigGroup windowConfig = KSharedConfig::openStateConfig()->group(u"Window"_s);
