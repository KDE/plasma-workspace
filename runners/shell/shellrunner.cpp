    ...
    : AbstractRunner(parent, metaData, args)
{
    ...
    addSyntax(RunnerSyntax(QStringLiteral(":q:"), i18n("Finds commands that match :q:, using common shell syntax")));
...
void ShellRunner::match(RunnerContext &context)
{
    QStringList envs;
...
void ShellRunner::run(const RunnerContext &context, const QueryMatch &match)
{
