This is a display manager theme for SDDM

It installs into ${INSTALL_PREFIX}/sddm/themes
A copy of components is installed into the same path

components is deliberately imported as "components" for this reason

For testing, I recommend symlinking ../lookandfeel/contents/components/ into components
