...
$XGETTEXT $(find . -name \*.cpp -o -name \*.h) -o "$podir"/ksmserver-logout-greeter.pot
...
$XGETTEXT --join-existing --language=JavaScript $(find . -name \*.qml -o -name \*.js) -o "$podir"/ksmserver-logout-greeter.pot
