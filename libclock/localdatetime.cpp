...
QDateTime LocalDateTime::dateTime() const
{
    return m_dateTime;
}

void LocalDateTime::setDateTime(const QDateTime &dateTime)
{
    m_dateTime = dateTime;
}

QString LocalDateTime::format() const
{
    return m_format;
}

void LocalDateTime::setFormat(const QString &format)
{
    m_format = format;
}
