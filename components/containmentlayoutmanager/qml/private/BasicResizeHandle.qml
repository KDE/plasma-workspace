...
ContainmentLayoutManager.ResizeHandle {
    ...
    Kirigami.ShadowedRectangle {
        ...
        border.color: Qt.tint(Kirigami.Theme.textColor, Qt.rgba(color.r, color.g, color.b, 0.3))
    }
    Rectangle {
        anchors {
            fill: parent
        ...
        gradient: Gradient {
            GradientStop {
                position: 0.0
                color: handle.pressed ? Qt.rgba(0, 0, 0, 0.15) : Qt.rgba(1, 1, 1, 0.05)
            }
            GradientStop {
                position: 1.0
                color: handle.pressed ? Qt.rgba(0, 0, 0, 0.15) : Qt.rgba(0, 0, 0, 0.05)
            }
        }
